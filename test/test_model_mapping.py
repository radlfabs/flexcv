...
def test_model_config_dict_init_with_mapping():
    ...
    mapping = {"requires_inner_cv": True, "n_trials": 50, "n_jobs_model": 2, "n_jobs_cv": 2, "params": {}}
...
def test_model_mapping_dict_init_with_mapping():
    # Test initialization with a mapping
    model_config = ModelConfigDict({"requires_inner_cv": True, "n_trials": 50, "n_jobs_model": 2, "n_jobs_cv": 2, "params": {}})
