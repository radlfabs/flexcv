...
def test_string_to_crossvalmethod_valid():
    ...
    assert string_to_crossvalmethod("ContinuousStratifiedKFold") == CrossValMethod.CONTISTRAT
    assert string_to_crossvalmethod("ContinuousStratifiedGroupKFold") == CrossValMethod.CONTISTRATGROUP
    assert string_to_crossvalmethod("ConcatenatedStratifiedKFold") == CrossValMethod.CONCATSTRATKFOLD
